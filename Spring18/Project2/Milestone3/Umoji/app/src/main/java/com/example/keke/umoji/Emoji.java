...
class Emoji {
    ...
    /**
     * Determines the closest emoji to the expression on th  e face, based on the
     * odds that the person is smiling and has each eye open.
     *
     * @param face The face for which you pick an emoji.
     */

    private static Emojis whichEmoji(Face face) {
        ...
        if(smiling) {
            if (leftEyeClosed && !rightEyeClosed) {
                emojis = Emojis.LEFT_WINK;
            }  else if(rightEyeClosed && !leftEyeClosed){
                emojis = Emojis.RIGHT_WINK;
            } else if (leftEyeClosed){
                emojis = Emojis.CLOSED_EYE_SMILE;
            } else {
                emojis = Emojis.SMILE;
            }
        } else {
        ...
        Log.d(LOG_TAG, "whichEmoji: " + emojis.name());
